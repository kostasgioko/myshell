...
> This product is a command-line interpreter or shell.

It provides a command line user interface for Unix-like operating systems. The shell can work in interactive mode, where the user inputs commands in real time, or in batch mode where the shell executes a series of commands defined in a batchfile.

# Installation

OS X & Linux:

1) Extract the 8791.tar.gz file.
2) Open the folder and enter the next folder named "8791".
...
Giokotos Konstantinos – kostasgioko8@gmail.com
